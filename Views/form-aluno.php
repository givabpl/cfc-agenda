    ...
    <div class="content">
        <div class="container">
            <form class="form-control" action="#" method="POST" enctype="multipart/form-data">
                ...
                <br><br>
                <div class="mb-3">
                    <label for="celular_aluno" class="form-label">
                        Celular do aluno
                    </label>
                ...
                <br><br>
                <div class="mb-3">
                    <label for="obs_aluno" class="form-label">
                        Observação
                    </label>
                    <textarea class="form-control" id="obs_aluno" name="obs_aluno" value="<?php echo isset($_POST['obs_aluno'])?$_POST['obs_aluno']:''?>"></textarea>
                    <div style="color:red">
                        <?php echo $msg[0] != ""?$msg[0]:'';?>
                    </div>
                </div>
