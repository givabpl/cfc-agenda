...
?>
	<div class="content">
	 ...
	 ?>
		...
		<br><br><h1 class="row justify-content-center align-items-center">Aluno</h1><br>
			...
			<?php
				...
				foreach($retorno as $dado)
				{
					echo "<tr>
							...
							<td>
								<a class='btn btn-warning' href='index.php?controle=alunooController&metodo=alterar&id={$dado->id_aluno}'>Alterar</a>
								&nbsp;&nbsp;
		...
		<a  class="btn btn-primary" href="index.php?controle=alunoController&metodo=gerar_pdf">Lista de Alunos</a>
